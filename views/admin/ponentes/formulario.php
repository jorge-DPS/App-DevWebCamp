    ...
    ?>
        ...
        <div class="formulario__imagen">
            <picture>
                ...
                <img lazy src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="imagen ponente">
            </picture>
        </div>
    <?php }; ?>
</fieldset>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="tags_input" placeholder="Ej. Node.js, PHP, CSS, Larevel, UI/UX">
